...
(function () {
    var title = $G("J_title"),
        ...
        autoSizeWidth = $G("J_autoSizeWidth"),
        autoSizeInputWidth = $G("J_autoSizeInputWidth"),
        tone = $G("J_tone"),
        me,
        preview = $G("J_preview");
    ...
    editTable.prototype = {
        init:function () {
            ...
            domUtils.on(autoSizeWidth, "click", me.autoSizeWidthHanler);
      ...
      autoSizeWidthHanler:function () {
        var example = $G("J_example");
        var tds = example.getElementsByTagName(example, "td");
        utils.each(tds, function (td) {
          td.removeAttribute("width");
        });
        if (autoSizeWidth.checked&&autoSizeInputWidth.value) {
          example.setAttribute('width', autoSizeInputWidth.value);
        } else {
          example.setAttribute('width', '800');
        }
      },
    ...
    dialog.onok = function () {
        ...
        editor.execCommand("edittable", {borderColor: tone.value, autoSizeWidth:autoSizeWidth.checked, width:autoSizeInputWidth.value});
