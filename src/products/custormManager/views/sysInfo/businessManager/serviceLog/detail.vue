  ...
  <div>
    ...
    <el-form
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="8">
          <el-form-item label="服务名称" prop="name" hide-required-asterisk>
            <el-input
              ref="refName"
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="8">
          <el-form-item label="服务人员" prop="servicePerson">
            <el-input
              ref="refImpPerson"
              v-model="detailForm.servicePerson"
              :disabled="disabledFlag"
              size="small"
              clearable
              maxlength="100"
        ...
        servicePerson: [
          { required: true,
            validator: (rule, value, callback) => {
              validateLength(rule, value, callback, true, ['服务人员', 1, 100]);
            },
            trigger: 'change' }
        ]
      },
