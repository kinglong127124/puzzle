...
import {
  ...
  postAttacheFiles
} from '@core/api/common/basic/basicUpload';
...
export default {
  ...
  methods: {
    ...
    async submitUpload(form) {
      ...
      const deleteDetailInfo = this.$utilsBasic.getDeleteDetailInfo(this.$route.name, this.$route.meta.title);
      params.sourceCode = deleteDetailInfo.code;
      params.sourceName = deleteDetailInfo.title;
